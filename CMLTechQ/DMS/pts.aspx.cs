...
namespace CMLTechQ.DMS
{
    public partial class pts : System.Web.UI.Page
    {
        ...
        private bool DateValidation(string dateString)
        {
            ...
            string[] format3 = new string[] { "MM/dd/yyyy" };
            string[] format4 = new string[] { "M/d/yyyy" };
            string[] format5 = new string[] { "d/M/yyyy" };
            if (DateTime.TryParseExact(dateString, format, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault, out dateValue))
                ...
                return true;
            else if (DateTime.TryParseExact(dateString, format3, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault, out dateValue))
                return true;
            else if (DateTime.TryParseExact(dateString, format4, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault, out dateValue))
                return true;
            else if (DateTime.TryParseExact(dateString, format5, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault, out dateValue))
                return true;
            else
                return false;
