<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DMS_Library_General.aspx.cs" Inherits="CMLTechQ.DMS.DMS_Library_General" EnableEventValidation="false" %>
                ...
                <div class="head">
                    ...
                    <div class="action-menu" style="width:35%;margin-top:2px">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="btnadd" runat="server" Text="Add Document"  OnClientClick="goAddDoc();" OnClick="btnadd_Click" class="control-general control-button-white-1 push_button pull-right" />
        ...
        <MasterTableView  Width="100%"   AutoGenerateColumns="false"  DataKeyNames="ITM_ID"  >
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn UniqueName="MANF_NAME" DataField="MANF_NAME" HeaderText="Manufacturer " HeaderStyle-Width="20%" ItemStyle-Width="20%" FilterControlWidth="100%"  >
                        <FilterTemplate >
                            <telerik:RadComboBox ID="RadComboBoxMANF_NAME"  DataTextField="MANF_NAME" DataSourceID="SqlDataSource2" Sort="Ascending" 
                                ...
                                runat="server"  OnClientSelectedIndexChanged="ManIndexChanged" Width="100%" Skin="Metro" OnItemDataBound="RadComboBoxMANF_NAME_ItemDataBound">
                                <Items>
                                    ...
                                    <td>
                                                ...
                                                <div style="display: inline-block;margin-left:10px;">
                                                    <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnaddnew" runat="server" Text="New" CssClass="control-general control-button-blue1 push_button"  OnClick="btnaddnew_Click" Width="100px" OnClientClick="goaddnewmanu();" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnsave" runat="server" Text="Save" CssClass="control-general control-button-greenlight push_button" Width="100px" OnClick="btnsave_Click"  OnClientClick="ClearSave();"/>
                                         </td>
                                        ...
                                        <td>
                                            <asp:Button ID="btncancel" runat="server" Text="Cancel" CssClass="control-general control-button-yellow1 push_button" OnClick="btncancel_Click"  Width="100px" OnClientClick="ClearSave();" />
                                        </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnmanu" runat="server" Text="Add" CssClass="control-general control-button-greenlight push_button" OnClick="btnmanu_Click" Width="100px" OnClientClick="closeaddnewmanu();" /></td>
                                            <td>
                                                <asp:Button ID="btncancelm" runat="server" Text="Cancel" CssClass="control-general control-button-yellow1 push_button" OnClick="btncancelm_Click" Width="100px"  OnClientClick="closeaddnewmanu();" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource4" ConnectionString="<%$ ConnectionStrings:DB_DBCMLConnectionString %>"
        ...
        //grid.repaint();
            ...
            function goAddDoc1() {
                ...
                oWnd.setUrl('DMS_Library_General.aspx');
                oWnd.show();
            }
            function ClearSave() {
            ...
            function goaddnewmanu() {
                var oWnd = $find("<%=RadWindow2.ClientID%>");
                oWnd.setUrl('DMS_Library_General.aspx');
                oWnd.show();
            }
            function closeaddnewmanu() {
            ...
            function goAddDoc() {
                ...
                _redirect = "DMS_Library_AddNewDoc?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=0";
                parent.document.getElementById("content").src = _redirect;
            }
