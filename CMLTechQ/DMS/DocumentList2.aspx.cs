...
{
    public partial class DocumentList2 : System.Web.UI.Page
    {
                ...
                case "1":
                    {
                        ...
                        string _redirect = "DocumentUpload1?Auth1=" + _auth1 + "&Auth2=" + _auth2 + "&Auth3=" + _auth3 + "&Auth4=3";
                ...
                case "1":
                    {
                        ...
                        string _auth2 = lblprjid.Text;
                        string _auth3 = lblfolder.Text;
                        string _redirect = "DocumentSchedule2?Auth1=" + _auth1 + "&Auth2=" + _auth2 + "&Auth3=" + _auth3 + "&Auth4=0";
                        Response.Redirect(_redirect);
                        break;
                    }
                case "2":
        ...
        protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edits")
            {
                ...
                txtrefrence.Text = (string)e.Item.Cells[8].Text;
