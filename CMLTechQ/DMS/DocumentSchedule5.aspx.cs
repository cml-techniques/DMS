...
{
    public partial class DocumentSchedule5 : System.Web.UI.Page
    {
        ...
        {
            string _path = "NavWebForm3?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=3" + "&Auth5=" + hmenufolder.Value;
