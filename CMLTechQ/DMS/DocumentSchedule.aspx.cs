...
{
    public partial class DocumentSchedule : System.Web.UI.Page
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("DocumentList1?" + Request.QueryString.ToString());
            Load_Basket();
        }
        ...
        {
            string _path = "DocumentList1?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=0";
