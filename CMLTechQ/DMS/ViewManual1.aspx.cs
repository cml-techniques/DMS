...
{
    public partial class ViewManual1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string _path = "https://dms.cmltechniques.com/DMS/Documents/" + _docname;
                ...
                statusviewer.Attributes.Add("src", "statusUpdate1?" + statuspath);
