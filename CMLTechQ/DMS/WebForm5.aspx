<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm5.aspx.cs" Inherits="CMLTechQ.DMS.WebForm5" %>
        ...
        <div id="container-menu-bar" style="left: 275px; z-index: -1">
            <div id="container-menu">
                ...
                <<ul class='nav'>
                     ...
                     <li class='item current'><a href='#' onclick="Godocuments(3);">Record Drawings</a></li>
 ...
 <%: Scripts.Render("~/bundles/scripts") %>
           <script type="text/javascript">
             ...
             function Godocuments(_type) {
                 ...
                 if (_type == 1) {
                     parent.document.getElementById("content").src = "WebForm3.aspx?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=" + _type;
                 }
                 else if (_type == 2) {
                     parent.document.getElementById("content").src = "WebForm4.aspx?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=" + _type;
                 }
                 else if (_type == 3) {
                     parent.document.getElementById("content").src = "WebForm5.aspx?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=" + _type;
                 }
                 else if (_type == 4) {
                     parent.document.getElementById("content").src = "WebForm6.aspx?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=" + _type;
                 }
             }
             function Viewslide() {
