<%@ Page Title="" Language="C#" MasterPageFile="~/DMS/MC1.Master" AutoEventWireup="true" CodeBehind="NavWebForm3.aspx.cs" Inherits="CMLTechQ.DMS.NavWebForm3" %>
                    ...
                    <div class="headtitle">
                        ...
                        <div class="action-menu" style="width:30%;margin-top:-4px">
                               ...
                               <ul class="tabs3">
                                ...
                                <li><a  runat="server" id="schedule" class="control-general control-button-white-1 push_button pull-right" href="#" onclick="changetype(2);">Scheduled</a></li>
                                <li><a  runat="server"  id="upload" class="control-general control-button-white-1 push_button pull-right current" href="#" onclick="changetype(1);">Uploaded</a></li>
