...
{
    public partial class DocumentSchedule6 : System.Web.UI.Page
    {
        ...
        {
            string _path = "NavWebForm4?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=4" + "&Auth5=" + hmenufolder.Value;
