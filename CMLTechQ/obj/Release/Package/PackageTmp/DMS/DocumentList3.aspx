<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentList3.aspx.cs" Inherits="CMLTechQ.DMS.DocumentList3" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblprjid" runat="server" Text="" Style="display: none"></asp:Label>
            <asp:Label ID="lblprjcode" runat="server" Text="" Style="display: none"></asp:Label>
	...
	OnItemCommand="RadGrid1_ItemCommand" Skin="Metro" AutoGenerateColumns="false"  OnItemDataBound="RadGrid1_ItemDataBound" HeaderStyle-CssClass="ghead" HeaderStyle-Font-Bold="true" > 
        <MasterTableView  Width="100%" TableLayout="Fixed"  AutoGenerateColumns="false"  DataKeyNames="doc_id"  >
            <Columns >
                <telerik:GridBoundColumn DataField="doc_ref" HeaderText="Engineers Reference" ItemStyle-Width="20%" HeaderStyle-Width="20%"  HeaderStyle-HorizontalAlign="left">
               </telerik:GridBoundColumn>

                <telerik:GridTemplateColumn ItemStyle-Width="50%" HeaderStyle-Width="50%" HeaderText="File Name">
                   <ItemTemplate>
                     ...
                     <a href="#" onclick="Goviewdocument('<%# DataBinder.Eval(Container.DataItem, "doc_id") %>','<%# DataBinder.Eval(Container.DataItem, "doc_name") %>','<%# DataBinder.Eval(Container.DataItem, "CMS") %>','<%# DataBinder.Eval(Container.DataItem, "title") %>');">
               ...
               <telerik:GridBoundColumn DataField="file_size" HeaderText="Size" ItemStyle-Width="15%" HeaderStyle-Width="15%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                ...
                <telerik:GridBoundColumn DataField="doc_id" HeaderText="doc_id" HeaderStyle-Width="0%" ItemStyle-Width="0%"  Display="false" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" >
                 ...
                 <telerik:GridBoundColumn DataField="title" HeaderText="title" HeaderStyle-Width="0%" ItemStyle-Width="0%" Display="false" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" >
               </telerik:GridBoundColumn>
                 <telerik:GridBoundColumn DataField="Type" HeaderText="Type" HeaderStyle-Width="0%" ItemStyle-Width="0%" Display="false" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" >
                  ...
                  <telerik:GridBoundColumn DataField="CMS" HeaderText="CMS" HeaderStyle-Width="0%" ItemStyle-Width="0%" Display="false" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" >
               </telerik:GridBoundColumn>
        ...
        <ClientSettings >
            ...
            <ClientEvents OnGridCreated="GridCreated" />
                                 ...
                                 <input type="hidden" id="hCMS" value="0" runat="server" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
 ...
 <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
        ...
        <script type="text/javascript">
            function Goviewdocument(docid, docname,CMS,title) {
                ...
                parent.location.replace("ViewFullDocument?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=" + docid + "&Auth5=" + docname + "&Auth6=" + CMS+ "&Auth7=" + title);
            }
