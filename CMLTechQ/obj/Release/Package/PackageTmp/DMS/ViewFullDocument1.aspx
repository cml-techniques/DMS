<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFullDocument1.aspx.cs" Inherits="CMLTechQ.DMS.ViewFullDocument1" %>
...
<body  style="overflow: hidden;">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lbluserid" runat="server" Text="" Style="display: none" />
         ...
         <asp:Label ID="lbldocname" runat="server" Text="" Style="display: none" />
        ...
        <div id="docview_area">
            <div class="pulldownbar" style="height:33px">
                <div class="togglemenu" style="padding:6px 5px">
                 ...
                 <div class="titles" style="padding:5px 0px">
                     <asp:Label ID="lbl_doctitle" runat="server" Text="" ></asp:Label>
                </div>
               <div class="togglemenuright">
                   <a href="#" onclick="CallBack();" class="control-general control-button-white-1 push_button pull-right"><i class="icon-backward"></i> BACK</a>
               </div>
            </div>
      ...
      <%--  <div id="offcanvas-search" class="prl-offcanvas">
        ...
        <script type="text/javascript">
            ...
            function CallBack() {
                ...
                var _auth5 = document.getElementById("hmenufolder");

                //var _auth4 = document.getElementById("lbltype");


                location.replace("Project2?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=1&Auth5="+ _auth5.value);
