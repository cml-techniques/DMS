<%@ Page Title="" Language="C#" MasterPageFile="~/DMS/MC1.Master" AutoEventWireup="true" CodeBehind="DocumentSchedule5.aspx.cs" Inherits="CMLTechQ.DMS.DocumentSchedule5" %>
...
<td style="width:100px">Document Type</td>
                                                    <td style="width:100px">
                                                        <telerik:RadDropDownList ID="drop_type" runat="server" Skin="Default" RenderMode="Classic" Width="220px">
                                                            <Items>
                                                                <telerik:DropDownListItem Text="PDF" Value="pdf" Selected="true" />
                                                                <telerik:DropDownListItem Text="DWF" Value="dwf"  />
                                                            </Items>
     ...
     <%: Scripts.Render("~/bundles/scripts") %>
          <script type="text/javascript">
              function BacktoDocument() {
                  ...
                  parent.document.getElementById("content").src = "NavWebForm3?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=4&Auth5="+_auth4.value;
              }
