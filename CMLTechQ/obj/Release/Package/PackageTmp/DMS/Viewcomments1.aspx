<%@ Page Title="" Language="C#" MasterPageFile="~/DMS/MC1.Master" AutoEventWireup="true" CodeBehind="Viewcomments1.aspx.cs" Inherits="CMLTechQ.DMS.Viewcomments1" %>
        ...
        <MasterTableView  Width="100%" TableLayout="Fixed"  AutoGenerateColumns="false"  DataKeyNames="comm_id" >
            <Columns >
               ...
               <telerik:GridBoundColumn DataField="comment" HeaderText="Comment"  Visible="false" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Justify">
                 ...
                 <telerik:GridBoundColumn DataField="up_user" HeaderText="Uploaded By"  ItemStyle-Width="11%" HeaderStyle-Width="11%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
               </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="com_date" HeaderText="Date" ItemStyle-Width="9%" HeaderStyle-Width="9%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                 ...
                 <telerik:GridBoundColumn DataField="resp" HeaderText="Cml Reponse" ItemStyle-Width="33%" HeaderStyle-Width="33%" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left">
               </telerik:GridBoundColumn>
              ...
              <div class="listcotainer">
                    <div class="listhead">
                        <h2 class="title pull-left">Awaiting CML Response</h2>
                         ...
                         <div class="clearfix"></div>
                    <div id="dvhead1"  runat="server" style="width:100%;" >
	...
	OnItemCommand="RadGrid2_ItemCommand" Skin="Metro" AutoGenerateColumns="false"  OnItemDataBound="RadGrid2_ItemDataBound" HeaderStyle-CssClass="ghead" HeaderStyle-Font-Bold="true">
            ...
            <Columns >
               ...
               <telerik:GridBoundColumn DataField="comment" HeaderText="Comment"  Visible="false" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left">
                ...
                <telerik:GridBoundColumn DataField="com_date" HeaderText="Date" ItemStyle-Width="9%" HeaderStyle-Width="9%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                 ...
                 <telerik:GridBoundColumn DataField="comm_id1" HeaderText="" ItemStyle-Width="33%" HeaderStyle-Width="33%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
               </telerik:GridBoundColumn>
      ...
      <script type="text/javascript">
          function getResponseData() {
              ...
              var e = document.getElementById("<%=dvhead.ClientID %>");
              ...
              if (e) {
                  ...
                  if (e.style.display == 'none') {
                      ...
                      document.getElementById("<%=hdivdis.ClientID %>").value = "1";
                     ...
                     setdiv(2);
                      ...
                      document.getElementById("<%=hdivdis.ClientID %>").value = "0";
          ...
          function GoPrint() {
              var id = document.getElementById("<%=lbldocid.ClientID %>").innerText;
              var prj = document.getElementById("<%=lblprjid.ClientID %>").innerText;
          ...
          function BacktoDocument() {
              ...
              parent.document.getElementById("content").src = "NavWebForm1?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth5=" + _auth4.value;
          }
          function OpenPdf(_search) {
              var _file = document.getElementById("<%=lblfile.ClientID %>");
          ...
          function Showimagewindow(_fileid) {
              ...
              var _auth1 = document.getElementById("<%=lblprjid.ClientID %>").innerHTML;
          ...
          function setdiv(type) {
              ...
              if (dataHeight + gridHeader.clientHeight <= div) {
          ...
          function GridCreated(sender, args) {
             ...
             SetHide(1);
              ...
              var hdis = document.getElementById("<%=hdivdis.ClientID %>").value;
              if (hdis == "0") {
                  SetHide(0);
              }
          }
          ...
          function GridCreated1(sender, args) {
              ...
              var hparent = $("<%=dvhead.ClientID %>").height();
              var pheight = 0;
              ...
              $("<%=dvhead1.ClientID %>").height(pheight);
        ...
        function SetHide(type) {
            ...
            if (type == 1) {
                $("#<%=dvhead.ClientID %>").show();
            }
            else {
                $("#<%=dvhead.ClientID %>").hide();
            }
        }
        function setPopupTitle(sender) {
            ...
            if (hfValue) {
                ...
                if (document.getElementById("#<%=etype.ClientID %>").value == 1) {
