<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentSchedule3.aspx.cs" Inherits="CMLTechQ.DMS.DocumentSchedule3" %>
    ...
    <%: Scripts.Render("~/bundles/scripts") %>
          <script type="text/javascript">
              function BacktoDocument() {
                  ...
                  parent.document.getElementById("content").src = "DocumentList3?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=0";
              }
          </script>
</body>
</html>
