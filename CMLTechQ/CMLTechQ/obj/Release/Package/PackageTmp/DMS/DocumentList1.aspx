<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentList1.aspx.cs" Inherits="CMLTechQ.DMS.DocumentList1" %>
        ...
        <script type="text/javascript">
            ...
            function CallLibrary() {
                ...
                if (_auth4.textContent.endsWith("@cmlgroup.ae")) {
                    ...
                    if (_auth2.textContent == "7") {
                        parent.document.getElementById("content").src = "DMS_Library_new?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=0";
                    }
                    else {
