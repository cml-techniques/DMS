<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewManual.aspx.cs" Inherits="CMLTechQ.DMS.ViewManual" ValidateRequest="false"  %>
<!DOCTYPE html>
...
<body  style="overflow: hidden;">
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="commentpanel">
                    ...
                    <div>
                        ...
                        <input style="font-weight: 600;display:none;" class="control-general control-button-upload push_button pull-right" type="button" value="Attached File" id="Button1" runat="server" onclick="PopupUpload();" />
                        <input type="file" id="myupload" runat="server" style="display: none;" onchange="GetValue();" />
                       

                    </div>
                     <div class="title" style="margin-top:5px;margin-bottom:0px;display:none;">
        ...
        <script type="text/javascript">
            $(function () {
                setInterval(refreshiframe, 300000);                
            });
            function refreshiframe() {                           
                $('#commentviewer').attr('src', $('#commentviewer').attr('src'));
            };
        ...
        <script type="text/javascript">
            ...
            function CallBack() {
                ...
                if (_auth2.textContent == 33 || _auth2.textContent == 51 || _auth2.textContent == 76) {
            ...
            function AddComment() {
                ...
                var _btn = document.getElementById("btnsavecomment");
                _btn.click();
