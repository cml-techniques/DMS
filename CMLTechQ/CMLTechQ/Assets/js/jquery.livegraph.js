...
(function( $ ){
	var methods = {
		...
		make : function () {
			...
			for ( x in data ) {
			    i++;
			    $('<div class=\"bar bar' + x + '\" bar=\"' + x + '\" id=\"' + x + '\" ><div class=\"barbackground\"></div>"<span class=\"barval \" ><p class=\"bardata bubble\">' + data[x].value + '%' + '</p></span><p class=\"barlabel\">' + data[x].label + '</p></div>').appendTo((this).find('div.bars'));
			...
			liveGraph.ref.find('div.liveGraph div.bars div.bar').css({
				...
				width: '10%',
				float: 'left',
				margin: '0 '+liveGraph.settings.barGapSize+'%'
			});
			liveGraph.ref.find('div.liveGraph div.bars div.bar span').css({
			    position: 'absolute',
			    bottom: 0,
			    left: 0,
			    width: liveGraph.settings.barWidth+'%',
			...
			liveGraph.ref.find('div.liveGraph div.bars div.bar p.barlabel').css({
				position: 'absolute',
				bottom: '-30px',
				margin: 0,
				left: 0,
			...
			//liveGraph.ref.find('div.liveGraph div.bars div.bar p.bardata').css({
			//    position: 'absolute',
			//    top: '-30px',
			//    margin: 0,
			//    left: 0,
			...
			//});
			//liveGraph.ref.find('div.liveGraph div.bars div.bar:hover p.bardata').css({
			//    position: 'absolute',
			//    top: '-30px',
			//    margin: 0,
			//    left: 0,
