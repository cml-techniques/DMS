...
namespace CMLTechQ.DMS
{
    public partial class Project1 : System.Web.UI.Page  
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (_type == "1")
                content.Attributes.Add("src", "NavWebForm1?" + _auth + "&Auth3=" + Request.QueryString["Auth3"].ToString());
            else if (_type == "2")
                content.Attributes.Add("src", "NavWebForm2?" + _auth + "&Auth3=" + Request.QueryString["Auth3"].ToString());
            else if (_type == "3")
                content.Attributes.Add("src", "NavWebForm3?" + _auth + "&Auth3=" + Request.QueryString["Auth3"].ToString());
            else if (_type == "4")
            {
                content.Attributes.Add("src", "NavWebForm4?" + _auth + "&Auth3=" + Request.QueryString["Auth3"].ToString());
            }
            //innernav.Attributes.Add("src", "InnerNav?" + _auth + "&Auth3=" + defaultNav + " &Auth4=" + _type);
                ...
                else
                {
                    ...
                    if (_type == "1")
                        ...
                        content.Attributes.Add("src", "NavWebForm1?" + _auth + "&Auth3=" + defaultFolder);
                        
                    else if(_type=="2")
                        content.Attributes.Add("src", "NavWebForm2?" + _auth + "&Auth3=" + defaultFolder);
                    else if (_type == "3")
                        content.Attributes.Add("src", "NavWebForm3?" + _auth + "&Auth3=" + defaultFolder);
                    else if (_type == "4")
                        content.Attributes.Add("src", "NavWebForm4?" + _auth + "&Auth3=" + defaultFolder);
