...
<%@ Page Title="" Language="C#" MasterPageFile="~/DMS/MC1.Master" AutoEventWireup="true" CodeBehind="DocumentSchedule4.aspx.cs" Inherits="CMLTechQ.DMS.DocumentSchedule4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="panes_">
                                <div class="pane" style="display: block;">
                                    <div id="Upload-container" style="top: 50px;bottom:0px;">
                                        <div class="container">
                                            <div class="selection">
     ...
     <script type="text/javascript">
         function BacktoDocument() {
             ...
             parent.document.getElementById("content").src = "NavWebForm2?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=2&Auth5="+_auth4.value;
         }
