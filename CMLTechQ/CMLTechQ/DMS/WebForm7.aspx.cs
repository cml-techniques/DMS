...
namespace CMLTechQ.DMS
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        private void Generate_Menu_boots()
        {
            ...
            foreach (DataRow _drow in _dtservice.Rows)
            {
                ...
                _menuItem += "<li class='main-menu-item'> <a href='#' onclick='GetMenu(1);'>" + _drow["folder_description"].ToString() + "</a><i class='fa fa-angle-right'></i>";



                // _objbll = new BLL_Dml();
                // _objdb = new _database();
                //_objdb.DBName = "DBCML";
                _clstreefolder _objcls1 = new _clstreefolder();
                _objcls1.Folder_id = Convert.ToInt32(_drow["folder_id"].ToString());
                DataTable _dtnav = _objbll.Load_AllsubFolders(_objcls1, _objdb);

                if (_dtnav.Rows.Count > 0) _menuItem += "<ul>";

                foreach (DataRow _drow1 in _dtnav.Rows)
                {

                    _folder = _drow1["folder_description"].ToString();
                    if (_folder.Length > 30)
                        _folder = _folder.Substring(0, 20) + "...";


                    _menuItem += "<li class='cas-sub-menu tier-two-menu-item'> <a href='#' onclick='GetMenu(1);'>" + _folder + "</a> <i class='fa fa-angle-right'></i>";


                    _clstreefolder _objcls2 = new _clstreefolder();
                    _objcls2.Folder_id = Convert.ToInt32(_drow1["folder_id"].ToString());
                    DataTable dt = new DataTable();
                    dt = _objbll.Get_CurrentUploadFolder(_objcls2, _objdb);

                    if (dt.Rows.Count > 0) _menuItem += "<ul>";

                    foreach (DataRow _drow2 in dt.Rows)
                    {

                        _menuItem += "<li class='tier-three-menu-item'> <a href='#' onclick='GetMenu(1);'>" + _drow2["folder_description"].ToString() + "</a></li>";
            ...
            string _content = _head + _menuItem + _foot;
            ...
            //    {
            //        if (_folder.Length > 30)
            //            _folder = _folder.Substring(0, 25) + "...";
            //        if (_idx == _pos)
        ...
        //        _menuItem += "<li> <a href='#' onclick='GetMenu(1);'>" + _drow["folder_description"].ToString() + "</a>";
        ...
        //        if (_folder.Length > 35)
        //            _folder = _folder.Substring(0, 35) + "...";


        //        _menuItem += "<li> <a href='#' onclick='GetMenu(1);'>" + _folder + "</a>";
        ...
        //            _menuItem += "<li> <a href='#' onclick='GetMenu(1);'>" + _drow2["folder_description"].ToString() + "</a></li>";
        ...
        private void Populate_Tree()
        {
            ...
            _obj.Load_Tree(lblprj.Text, lbluserid.Text);
            ...
            foreach (var row in _service)
            {
                ...
                _menuItem += "<li class='main-menu-item'> <a href='#'>" + row["Folder_description"].ToString() + "</a><i class='fa fa-angle-right'></i>";
                ...
                foreach (var row1 in _package)
                {
                    ...
                    _folder = row1[2].ToString();

                    if (_folder.Length > 35)
                        _folder = _folder.Substring(0, 35) + "...";


                    _menuItem += "<li class='tier-two-menu-item'> <a href='#' >" + _folder + "</a><i class='fa fa-angle-right'></i>";
                    ...
                    foreach (var row2 in _doctype)
                    {
                        ...
                        _menuItem += "<li class='tier-three-menu-item'> <a href='#' onclick='GetMenu(" + row2["Folder_Id"].ToString() + "," + row2["type"].ToString() + ");'>" + row2["folder_description"].ToString() + "</a></li>";
