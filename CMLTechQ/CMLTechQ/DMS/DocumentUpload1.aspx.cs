...
{
    public partial class DocumentUpload1 : System.Web.UI.Page
    {
        ...
        if (lbltype.Text == "2")
        {
            _path = "DocumentList1?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=" + lbltype.Text;
        }
        else if (lbltype.Text == "3")
        {
            _path = "DocumentList2?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=" + lbltype.Text;
        }
        else if (lbltype.Text == "4")
        {
            _path = "DocumentList3?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=" + lbltype.Text;
        }
