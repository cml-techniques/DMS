<%@ Page Title="" Language="C#" MasterPageFile="~/DMS/MC1.Master" AutoEventWireup="true" CodeBehind="statusUpdate1.aspx.cs" Inherits="CMLTechQ.DMS.statusUpdate1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script lang="javascript">
        ...
        function CallBack() {
            ...
            var _auth4 = document.getElementById("<%=lblfolder.ClientID %>");

            parent.location.replace("Project2?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent);
        }
    </script>
</asp:Content>