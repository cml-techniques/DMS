<%@ Page Title="" Language="C#" MasterPageFile="~/DMS/MC1.Master" AutoEventWireup="true" CodeBehind="NavWebForm2.aspx.cs" Inherits="CMLTechQ.DMS.NavWebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <input type="hidden" id="hmenufolder" runat="server" />
        ...
        <div id="doc-container" style="top: 45px; overflow-x:hidden; left: 275px; z-index: 700;">
                    ...
                    <table cellspacing="0" border="0" style="width: 100%;">
                        <tr style="height: 100%">
                            ...
                            <%--  <ul class="tabs3" id="ulib">--%>
                                ...
                                <input  type="button" runat="server" class="control-general control-button-green-1 push_button current"  value="Library"  id="btnlibrary" onclick="CallLibrary();"/>
                            ...
                            <div class="subheader">
                                <table style="color: #353535;width:100%" border="0" cellspacing="0" cellpadding="5">
                                      ...
                                      <tr>
                                       ...
                                       <td><asp:TextBox ID="txtManufacturer" CssClass="control-textbox-2"  runat="server"  Width="350px" ></asp:TextBox></td>
                                          </tr>
                                    <tr>
      ...
      <%: Scripts.Render("~/bundles/scripts") %>
        <script type="text/javascript">
            ...
            function SetPermission() {
                ...
                var _auth1 = document.getElementById("<%=lbluserid.ClientID %>");
                if (!_auth1.textContent.endsWith("@cmlgroup.ae")) {

                    document.getElementById("<%=btnlibrary.ClientID %>").style.cursor = "not-allowed";
                    document.getElementById("<%=btnlibrary.ClientID %>").disabled = "true";

                    $("#<%=btnlibrary.ClientID %>").css("background-color", "#A9A9A9");

                    $("#<%=btnlibrary.ClientID %>").removeClass("control-button-green-1");
                    $("#<%=btnlibrary.ClientID %>").addClass("control-button-white-1");
            ...
            function CallLibrary() {
                ...
                var _auth4 = document.getElementById("<%=lbluserid.ClientID %>");

                var _auth5 = document.getElementById("<%=hmenufolder.ClientID %>");

                if (_auth4.textContent.endsWith("@cmlgroup.ae")) {

                    parent.document.getElementById("content").src = "DMS_Library_General1?Auth1=" + _auth1.textContent + "&Auth2=" + _auth2.textContent + "&Auth3=" + _auth3.textContent + "&Auth4=0" + "&Auth5=" + _auth5.value;
                }
            }
