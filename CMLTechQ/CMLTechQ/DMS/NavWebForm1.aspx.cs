...
{
    public partial class NavWebForm1 : System.Web.UI.Page
    {
        ...
        private void loadPageprojectinfo()
        {
            ...
            //pageinfo.Text = "Mechanical Services > Cooling Towers > O&M Manual";
        ...
        protected void btndummyView_Click(object sender, EventArgs e)
        {
            ...
            if (docviewcomment)
            {
                ...
                _redirect = "ViewManual?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=" + hdocid.Value + "&Auth5=" + hmenufolder.Value +  "&Auth6=" + hfile.Value; 
            ...
            {
                _redirect = "ViewFullDocument1?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=" + hdocid.Value + "&Auth5=" + hmenufolder.Value;
            }
            ScriptManager.RegisterStartupScript(this, typeof(string), "close", "parent.location.replace('" + _redirect + "');", true);
        ...
        {
            string _redirect = "OMUpload1?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text +"&Auth5=" + hmenufolder.Value;
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                txtdocid.Text = (string)e.Item.Cells[11].Text;
                txt_doctitle.Text = (string)e.Item.Cells[13].Text;
                ...
                string contactor = (string)e.Item.Cells[12].Text;
            ...
            {
                lbldocid.Text = (string)e.Item.Cells[11].Text;
            ...
            {
                hfile.Value = (string)e.Item.Cells[14].Text;
        ...
        protected void RadGrid2_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edits")
            {
                txt_doctitle.Text = (string)e.Item.Cells[14].Text;
                txtdocid.Text = (string)e.Item.Cells[11].Text;
