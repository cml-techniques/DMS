...
{
    public partial class NavWebForm3 : System.Web.UI.Page
    {
        ...
        private void loadPageprojectinfo()
        {
           ...
           // pageinfo.Text = "Mechanical Services > Cooling Towers > Record Drawings";
        }
        private void load_document()
        {
            ...
            //doc_list.DataBind();
            //_result = _dt.Select("Enabled=false");
            //_dtresult = _result.Any() ? _result.CopyToDataTable() : _dt.Clone();
        ...
        private void DownLoad_Single(string _filename)
        {
            try
            {
                ...
                if (_finfo.Exists == false)
                {
                    ...
                    Response.Redirect("NavWebForm3?" + Request.QueryString.ToString());
                    return;
                }
                Response.Clear();
                ...
                case "1":
                    {
                        ...
                        string _redirect = "DocumentUpload2?Auth1=" + _auth1 + "&Auth2=" + _auth2 + "&Auth3=" + _auth3 + "&Auth4=3&Auth5=" + hmenufolder.Value;
                ...
                case "1":
                    {
                        ...
                        string _auth2 = lblprjid.Text;
                        string _auth3 = lblfolder.Text;
                        string _redirect = "DocumentSchedule5?Auth1=" + _auth1 + "&Auth2=" + _auth2 + "&Auth3=" + _auth3 + "&Auth4=3" + "&Auth5=" + hmenufolder.Value;
                        Response.Redirect(_redirect);
                        break;
                    }
                case "2":
        ...
        protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edits")
            {
                ...
                //txtfilename.Text = (string)e.Item.Cells[2].Text;
        ...
        protected void RadGrid2_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edits")
            {
                ...
                txtrefrence.Text = (string)e.Item.Cells[3].Text;
                txtfilename.Text = (string)e.Item.Cells[4].Text;
