    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
            ...
            protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //_objdb.DBName = "DBCML";
                //_objcls.Folder_id = Convert.ToInt32(1);
                //DataTable _dtdetails = _objbll.Load_AllProgressTracking(_objcls, _objdb);
                ////Repeater _rptdetails = (Repeater)e.Item.FindControl("rptdetails");
                //rptdetails.DataSource = _dtdetails;
                //rptdetails.DataBind();
        ...
        private void Load_Details()
        {
           ...
           DataTable _dtservice = _objbll.load_ProgressTreeFolder_Tbl(_objcls, _objdb);
            ...
            ddlfolder.DataValueField = "ProgressFolder_id";
        ...
        protected void rptdetails_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //TextBox txt1 = (TextBox)e.Item.FindControl("txt1");
                Image img6 = (Image)e.Item.FindControl("img6");
                Label lbl6 = (Label)e.Item.FindControl("lbl6");
                //TextBox txt1 = (TextBox)e.Item.FindControl("txt1");
                Image img7 = (Image)e.Item.FindControl("img7");
                Label lbl7 = (Label)e.Item.FindControl("lbl7");
                //TextBox txt1 = (TextBox)e.Item.FindControl("txt1");
                Image img8 = (Image)e.Item.FindControl("img8");
                Label lbl8 = (Label)e.Item.FindControl("lbl8");
                //TextBox txt1 = (TextBox)e.Item.FindControl("txt1");
                Image img9 = (Image)e.Item.FindControl("img9");
                Label lbl9 = (Label)e.Item.FindControl("lbl9");
                //TextBox txt1 = (TextBox)e.Item.FindControl("txt1");
                Image img10 = (Image)e.Item.FindControl("img10");
                ...
                if (!DBNull.Value.Equals(((DataRowView)e.Item.DataItem).Row["section1"]))
                {
                    ...
                    {
                        //img1.Attributes.Add("style", "visiblility:visible");
                        //img1.Attributes.Add("style", "disply:block");
                        //lbl1.Attributes.Add("style", "display:none");

                        //img1.Visible = true;
                        img1.Attributes.Add("style", "visibility:visible");
                        img1.Attributes.Add("style", "display:block");
                        //img1.Visible = true;
                    }
                    else
                    {
                        string ss = "";
                        //lbl1.Visible = true;
                        lbl1.Attributes.Add("style", "visibility:visible");
                        lbl1.Attributes.Add("style", "display:block");
                        //lbl1.Visible = true;
                    }
                }
       ...
       void  GetDraft_issueDate()
        ...
        protected void UpdateChanges(object sender, EventArgs e, int cntno)
        {
            ...
            lbl.Text = tb.Text;
                ...
                Image img = (Image)rp.FindControl("img" + cntno);
        ...
        protected void btnfolder_Click(object sender, EventArgs e)
        {
           ...
           // UpdatePanel1.Update();
            ...
            Response.Redirect("ProgressTrackingSheet.aspx?" + Request.QueryString.ToString());
