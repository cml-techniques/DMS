...
{
    public partial class OMUpload : System.Web.UI.Page
    {
        ...
        private void Load_DocumentStatus()
        {
            ...
            drop_status.DataSource = _dt;
            drop_status.DataTextField = "StatusName";
            drop_status.DataValueField = "StatusId";
        ...
        private bool EmpyValidation()
        {
            ...
            {
                //ScriptManager.RegisterStartupScript(this, typeof(string), "close", "alert('Enter File');", true);
            ...
            if (_objbll.ValidateDocumentRevision(_objcls, _objdb) == 1)
            {
                lblError.Text = "Selected revision already exists in the folder. Please select another revision.";
                return true;
            }
        ...
        void load_users()
        {
            ...
            var list = from o in _dt.AsEnumerable()
                       where o.Field<string>(1) == "Review/Comment" || o.Field<string>(1) == "Review/Comment/Status" || o.Field<string>(1) == "Admin"
                       select o;
        ...
        void SendMail(string user_id, string access, string project, int type, string value)
        {
            ...
            else
            {
                if (type == 1)
                {
                    if (access == "Review/Comment" || access == "Admin")
                    {
        ...
        protected void btnAddstyle_Click(object sender, EventArgs e)
        {
            ...
            lbldocstyleId.Text = drop_style.SelectedItem.Value;
