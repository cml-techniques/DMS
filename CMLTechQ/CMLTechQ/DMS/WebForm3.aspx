<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="CMLTechQ.DMS.WebForm3" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="container-menu-bar" style="left: 275px; z-index: -1">
            <div id="container-menu">
                ...
                <ul class='nav'>
                    <li class='item current'><a class='current' href='#' onclick="Godocuments(1);">O&M Manual</a></li>
                                                    ...
                                                    <table style="border: none; display: grid; border: none;" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td style="border: none; padding: 0px; width: 20px">
                                                                <img src="../Assets/img/pdf-16.png" alt="" /></td>
                                            ...
                                            <telerik:GridTemplateColumn DataField="title" HeaderText="Document Title" ItemStyle-Width="35%" HeaderStyle-Width="35%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                                    ...
                                                    <table style="border: none;" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td style="border: none; padding: 0px; width: 20px">
                                                                <img src="../Assets/img/pdf-16.png" alt="" class="pull-left" />
