...
{
    public partial class DocumentSchedule3 : System.Web.UI.Page
    {
         public static int _folderid = 0;
            ...
            private DataSet Read_File(string _file)
            {
                ...
                excelConn.Open();
                DataTable dtPatterns = new DataTable(); excelCommand = new OleDbCommand("SELECT `REF` as REF, `TITLE` as TITLE,`FILENAME` as FILENAME FROM [TD$]", excelConn);
                excelDataAdapter.SelectCommand = excelCommand;
                excelDataAdapter.Fill(dtPatterns);
                dtPatterns.TableName = "TD";
            ...
            protected void btnsave_Click(object sender, EventArgs e)
            {
                ...
                Response.Redirect("DocumentList3?" + Request.QueryString.ToString());
                Load_Basket();
            }
            ...
            {
                string _path = "DocumentList3?Auth1=" + lbluseridhidden.Text + "&Auth2=" + lblprjid.Text + "&Auth3=" + lblfolder.Text + "&Auth4=0";
